...
export declare const MenuSub: ({ children: propsChildren, items, portalOptions, subOptions, triggerOptions: { className: propsClassName, preFix, endFix, type, ...otherTriggerOptions }, subContentOptions: { className: subContentClassName, ...otherSubContentOptions }, }: MenuSubProps) => import("react/jsx-runtime").JSX.Element;
