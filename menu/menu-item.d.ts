...
export declare const MenuItem: ({ children: propsChildren, type, className: propsClassName, preFix, endFix, ...otherProps }: MenuItemProps) => import("react/jsx-runtime").JSX.Element;
